...
$course_summary =   $OUTPUT->get_course_summary_file($course);
...
$templatecontext = [
    ...
    'hascourse_summary' => !empty($course_summary)
];

//$templatecontext['flatnavigation'] = $PAGE->flatnav;
$templatecontext['flatnavigation'] = flatnav_icon_support($PAGE->flatnav);
echo $OUTPUT->render_from_template('theme_emphasize/course_view', $templatecontext);
